---
layout: post
title: "[Pt 2] Installing and Configuring the Kubernetes Dashboard with Kind"
date: 2020-02-22 12:00:00 -0500
archive: true
date_source: legacy_git_first_commit
---

![Photo by Steve Harvey on Unsplash](/assets/images/blog/part2-k8s-dashboard.png)

In [Part 1](/blog/2020/02/22/pt1-k8s-dashboard.html) we got a Kubernetes Dashboard up and running along side a small application called [kuard](https://github.com/kubernetes-up-and-running/kuard) to visualize what was happening in the cluster. In this post we'll explore the best practices when working with the Kubernetes Dashboard.
...
![dashboard auth](/assets/images/blog/dashboard1.png)
...
![exec](/assets/images/blog/exec.png)
