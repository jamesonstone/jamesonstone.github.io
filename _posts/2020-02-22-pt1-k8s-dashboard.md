---
layout: post
title: "[Pt 1] Installing and Configuring the Kubernetes Dashboard with Kind"
date: 2020-02-22 12:00:00 -0500
archive: true
date_source: legacy_git_first_commit
---

![Photo by Marek Szturc on Unsplash](/assets/images/blog/dashboard.png)
...
![auth method](/assets/images/blog/dashboard1.png)
...
![dashboard2](/assets/images/blog/dashboard2.png)

From here we can mess with Kuard's features to simulate different use cases within the cluster

![kuard](/assets/images/blog/kuard.png)

## Conclusion

We'll follow up in [Part 2](/blog/2020/02/22/pt2-k8s-dashboard.html) configuring the dashboard.
