---
layout: post
title: "Getting Started Avro Schema and Debezium"
date: 2020-03-04 12:00:00 -0500
archive: true
date_source: legacy_git_first_commit
---

![schematics](/assets/images/blog/avro-schema.png)
...
In the past, we've setup Debezium to stream data changes in the [MySQL](/blog/2020/03/01/kotlinconsumer.html) and [PostgreSQL](/blog/2020/01/25/debezium.html) database. Today, we'll use it to inspect the message being produced by the Debezium connector, and pushed into Kafka for consumption.

![topic view](/assets/images/blog/topic-ui-avro.png)
...
![schema UI](/assets/images/blog/schema-ui.png)
